      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[601] w-[680px] max-w-[95vw] bg-[#0d1117] rounded-[20px] border border-white/[0.08] shadow-[0_40px_80px_rgba(0,0,0,0.6)] overflow-hidden"
          >
            {/* Terminal Titlebar */}
            <div className="flex items-center justify-between px-5 py-3 border-b border-white/[0.06] bg-[#161b22]">
              ...
              <span className="text-[11px] font-mono text-[#484f58]">alins@portfolio ~ /terminal</span>
              <span className="text-[10px] font-mono text-[#484f58]">Press ` to close</span>
            </div>

            {/* Output */}
            <div ref={outputRef} className="px-5 py-4 h-64 overflow-y-auto font-mono text-[12px] leading-[1.8] space-y-0.5">
              {lines.map((line, i) => (
            ...
            <div className="px-5 py-3 border-t border-white/[0.06] bg-[#161b22]">
              <form onSubmit={handleSubmit} className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent font-mono text-[12px] text-[#e6edf3] outline-none placeholder:text-[#484f58] caret-emerald-400"
